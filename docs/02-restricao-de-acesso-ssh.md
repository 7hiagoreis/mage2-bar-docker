...
A chave pública foi adicionada ao arquivo authorized_keys do usuário devops.
...
Antes de qualquer alteração no SSH, foi validado que o acesso por chave pública funciona corretamente para o usuário devops.
